<?php
	...
	$pdf->Cell(540,20,'PROMOCION MITAD DE PRECIO',1,1,C);
	$pdf->Ln(20);
	$pdf->SetFont('Arial','B',10);

	$pdf->Cell(540,30,'Promocion consumir un plato en promocion obtienes un ticket de descuento cuando vuelvas',1,1,'C');

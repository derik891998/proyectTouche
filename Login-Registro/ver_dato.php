...
<html lang="es">
    <head>
        ...
        <title>Datos Touche</title>
        <link href="ver_registro/css/styles.css" rel="stylesheet" />
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
                      ...
                      <!--ajustar tabla de dato--
                        <div class="card mb-4">
                        <!--ajustar tabla de dato-->
    
    
    
                            <div class="card-header"><i class="fas fa-table mr-1"></i>Datos Touche</div>
                            <div class="card-body">
        ...
        <script src="ver_registro/js/scripts.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js" crossorigin="anonymous"></script>
        <script src="ver_registro/assets/demo/chart-area-demo.js"></script>
        <script src="ver_registro/assets/demo/chart-bar-demo.js"></script>
        <script src="https://cdn.datatables.net/1.10.20/js/jquery.dataTables.min.js" crossorigin="anonymous"></script>
        <script src="https://cdn.datatables.net/1.10.20/js/dataTables.bootstrap4.min.js" crossorigin="anonymous"></script>
        <script src="ver_registro/assets/demo/datatables-demo.js"></script>
...
<BR><BR>
    ...
    <br><br>
    <center>
    <h1>ACTUALIZAR - BORRAR - EDITAR DATO TOUCHE</h1>
    </center>
...
<BODY>
<?php
include("conexion_editar.php");
$totalderegistros=1;
$result = mysqli_query($conexion, "SELECT * FROM alumno order by cod_alumno");
echo "<CENTER>";
...
echo "<TD>";
echo $fila[3]." ".$fila[2];
echo "<TD><a href = academia2021a/VerDatos.php?cod=$fila[0] >Ver</a> ";
echo "<TD><a href = academia2021a/Eliminar.php?cod=$fila[0] >Eliminar</a>";
echo "<TD><a href = academia2021a/Actualiza.php?cod=$fila[0] >Actualizar</a>";
++$totalderegistros;
}
echo "</TABLE>";
$numero = mysqli_num_rows($result);
echo "<p align='center'><a href=../index.php>Volver</a></p>";
...
echo"<th>".$row["clave"]."</th>\n";
   ...
   echo "<TD><a href = academia2021a/VerTouche.php?cod=$fila[0] >Ver</a> ";
echo "<TD><a href = academia2021a/EliminarTouche.php?cod=$fila[0] >Eliminar</a>";
...
<font size="5"> Restaurante : Touche<br>
    ...
    <img id="logo_registro" src="imagenes/logo1.jpg">

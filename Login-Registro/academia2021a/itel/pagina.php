...
<link rel="icon" href="fuego.jpg" type="image/png">
...
<header id="header_wrapper">
  <div class="container">
    <div class="header_box">
      <div class="logo"><a href="http://itel.unjbg.edu.pe/"><img src="img/itel.png" alt="logo"></a></div>
...
<!--slider-->
  ...
  <div class="slider-wrapper theme-mi-slider">
    <div id="slider" class="nivoSlider">     
        <img src="img/itel.png" alt="" title="#htmlcaption1" />    
  ...
  <div class="portfolio"> 
    ...
    <div class="isotope fadeInLeft animated wow" style="position: relative; overflow: hidden; height: 480px;" id="portfolio_wrapper"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   prototype isotope-item">
        <div class="portfolio_img"> <img src="img/medicina.jpg"  alt="Portfolio 1"> </div>        
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(337px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design isotope-item">
        <div class="portfolio_img"> <img src="img/pesquera.jpg" alt="Portfolio 1"> </div>
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(674px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  appleIOS  isotope-item">
        <div class="portfolio_img"> <img src="img/comercial.jpg" alt="Portfolio 1"> </div>
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(674px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four amazon  isotope-item">
        <div class="portfolio_img"> <img src="img/amazon.jpg" alt="Portfolio 1"> </div>
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(1011px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  android  prototype web isotope-item">
        <div class="portfolio_img"> <img src="img/derecho.jpg" alt="Portfolio 1"> </div>
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design isotope-item">
        <div class="portfolio_img"> <img src="img/civil.jpg" alt="Portfolio 1"> </div>
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(337px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  web isotope-item">
        <div class="portfolio_img"> <img src="img/quimica.jpg" alt="Portfolio 1"> </div>
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(674px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design web isotope-item">
        <div class="portfolio_img"> <img src="img/sistemas.jpg" alt="Portfolio 1"> </div>       
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(1011px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   android isotope-item">
        <div class="portfolio_img"> <img src="img/arquitectura.jpg" alt="Portfolio 1"> </div>       
        <div class="item_overlay">
          <div class="item_info"> 
...
<li><a href="https://www.apple.com/la/iphone/"><img src="img/client_logo1.png" alt=""></a><a href="javascript:void(0)"></a></li>
<li><a href="https://www.android.com/intl/es_es/"><img src="img/client_logo2.png" alt=""></a><a href="javascript:void(0)"></a></li>
<li><a href="https://www.samsung.com/pe/"><img src="img/client_logo3.png" alt=""></a><a href="javascript:void(0)"></a></li>
<li><a href="https://www.microsoft.com/es-es"><img src="img/client_logo5.png" alt=""></a><a href="javascript:void(0)"></a></li>
<li><a href="https://www.amazon.com/-/es/"><img src="img/client_logo5.png" alt=""></a><a href="javascript:void(0)"></a></li>

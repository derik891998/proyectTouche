...
$pdf->SetY(30);
$pdf->SetX(30);
$pdf->Image('logoitel.png',5,5,30); //('imagen', x,y,ancho)
$pdf->Cell(150,10,"Listado de Alumnos",'LRTB',0,'C');
$pdf->Image('logoitel.png',165,5,30); //('imagen', x,y,ancho)
$pdf->Ln();
...
$pdf->Cell($w[1],5,$row[3],'LRTB',0,'L'); //Apell
$pdf->Cell($w[2],5,$row[2],'LRTB',0,'L'); //nomb
$pdf->Cell($w[3],5,$row[1],'LRTB',0,'C'); //Especialidad
